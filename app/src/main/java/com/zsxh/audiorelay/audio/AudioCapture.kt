...
class AudioCapture(
    ...
    fun start(): AudioRecord {
        val config = AudioPlaybackCaptureConfiguration.Builder(mediaProjection)
            ...
            .addMatchingUsage(android.media.AudioAttributes.USAGE_VOICE_COMMUNICATION_SIGNALLING)
            ...
            .addMatchingUsage(android.media.AudioAttributes.USAGE_ASSISTANCE_ACCESSIBILITY)
